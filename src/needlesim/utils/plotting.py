...
def plot_sdf_background(env, ax=None, vmin=-20.0, vmax=20.0, colorbar_label="signed distance [mm]"):
    ...
    im = ax.imshow(env.sdf, origin="lower", extent=extent, cmap="RdBu", vmin=vmin, vmax=vmax)
    ax.contour(env.sdf, levels=[0.0], colors="k", linewidths=1.5, extent=extent, origin="lower")
